                                                        ...
                                                        instagram.getLines(function(instagramm){
                                                            ...
                                                            wish.getLines(function(wishh){
                                                                ...
                                                                cod.getLines(function(codd){
                                                                    hulu.setPath("./comptes/hulu.txt")
                                                                    hulu.setExtensions(ExtensionsFactory.from("txt"));
                                                                    hulu.addRule(Rules.ignoreDir, ".git", ".idea", "node_modules");  // Ignores given directories
                                                                    hulu.getLines(function(huluu){
                                                                    
fs.appendFile(filePath, os.EOL + args[0], function (err) {
                if (err) return console.log(err);
                const embed = {
                    title: "STOCK !? (Quand le stock est a 1 ses egale a 0)",
